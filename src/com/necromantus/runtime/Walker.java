    ...
    private Object _walk(Node n) throws Exception {
        ...
        if (n.nodeType == NodeType.ACTION && n.nodeType2 == NodeType.ActionNodeType.OPERATOR) {
            ...
            switch (n.value.toString()) {
                ...
                default:
                    throw new Exception("Unknown operator " + n.value.toString()+ " At " + n.line);
            }
            ...
            if (scope.containsVar(n.value.toString())) {
                ...
                throw new Exception("Unknown variable " + n.value + "." + " At " + n.line);
            }
            ...
            if (scope.containsVar(n.left.value.toString()) || scope.containsFunc(n.left.value.toString()))
                throw new Exception("Variable or function " + n.left.value.toString() + " already exists." + " At " + n.line);
            ...
            if (!scope.containsVar(n.left.value.toString()))
                throw new Exception("Variable " + n.left.value.toString() + " doesn't exist."+ " At " + n.line);
            ...
            if (!scope.containsFunc(n.left.value.toString()))
                throw new Exception("Function " + n.left.value.toString() + " does not exist"+ " At " + n.line);
            ...
            if (expr instanceof Boolean) {
                ...
                throw new Exception("Expected a boolean, but got " + getTypeName(expr)+ " At " + n.line);
        } else if (n.nodeType == NodeType.LOOP) {
            Object expr = _walk(n.left);
            if (!(expr instanceof Boolean)) {
                throw new Exception("Expected bool, but got " + getTypeName(expr)+ " At " + n.line);
            }
            while((Boolean) expr) {
        ...
        throw new Exception("Uh... Something went wrong... That's not your fault! DEBUG: Walker doesn't know this thing, \n" +
                ...
                "nodeType = " + n.nodeType + " nodeType2 = " + n.nodeType2 + "  value = " + n.value + " At " + n.line);
    }
